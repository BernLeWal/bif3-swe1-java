...
class SimpleLightsaberTest {
    ...
    void testGetColor_LukeShouldBeGreen() {
        ...
        assertTrue( lightsaber.getColor() == Lightsaber.Color.GREEN, "Lukes lightsaber color should be GREEN" );
    }
    ...
    void testGetColor_DarthShouldBeRed() {
        ...
        assertFalse( lightsaber.getColor() != Lightsaber.Color.RED, "Darths lightsaber color should be RED" );
    }
    ...
    void testGetColor_WrongFighterShouldBeNone() {
        ...
        assertEquals( lightsaber.getColor(), Lightsaber.Color.NONE, "For unknown fighters the color should be NONE");
    }
    ...
    void testGetColor_UnusedShouldBeNone() {
        Lightsaber lightsaber = new Lightsaber();
        if( lightsaber.getColor() != Lightsaber.Color.NONE ) {
